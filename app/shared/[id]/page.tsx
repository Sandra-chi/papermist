        ...
        <section className="space-y-6">
          ...
          <div className="rounded-[28px] border border-white/70 bg-white/85 p-6 shadow-sm">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs text-slate-400">{dayEvents.length} 条</span>
            </div>
        ...
        <section className="space-y-6">
          <div className="rounded-[28px] border border-white/70 bg-white/85 p-6 shadow-sm">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs text-slate-400">{dayTodos.length} 条</span>
            </div>
          ...
          <div className="rounded-[28px] border border-white/70 bg-white/85 p-6 shadow-sm">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs text-slate-400">{dayEntries.length} 条</span>
            </div>
